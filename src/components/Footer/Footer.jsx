    ...
    return (
        ...
        <div className="mb-0">
            ...
            <aside className="text-center ml-8 lg:ml-0">
                    <img className="w-14 h-16 rounded-md ml-[88px]" src="https://i.ibb.co/ggJSvML/logo-genial-pour-atelier-art-710103-336.jpg" alt="" />
                    <p className=""><span className="text-2xl">Craftopia</span><br />Providing reliable tech since 1992</p>
                </aside>
