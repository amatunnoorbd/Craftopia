...
const OilPainting = () => {
    ...
    useEffect(() =>{
        ...
        .then(res => res.json())
        .then(datas =>{
            const data = datas.filter(data => data.subcategory_name === "Oil Painting");
            // console.log(data);
            setItems(data);
        })
    ...
    return (
        <div className="mt-10 mb-24 min-h-[70vh]">
            <h1 className="bg-white py-3 rounded mx-auto max-w-xl text-3xl lg:text-5xl mb-6 font-semibold text-center">Oil Painting</h1>
